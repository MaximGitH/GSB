...
$i = 0;
    ...
    echo '<div class = "block"><center><h2>Eléments présent dans le forfait : Consultation fiche visiteur </h2>
<table>
  <thead>
    ...
    <th><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMontant Rembousé</th>
...
for($nbrquantite =4;count($quantite) >= $nbrquantite;$nbrquantite = $nbrquantite +4 ){
  ...
  echo '<tbody>
    <tr>
      ...
      <td><button class="button" name ="button" type="submit" value="'.$nbrquantite.'">supprimer</button></td>;
<tr>';
  if($etat2[$i] == 'valide'){
      echo'<td><button      name ="buttonconfirme" type="submit" value="'.($nbrquantite).'"> Confirmer</button></td>';
  }
  else{
      echo'<td><button   name ="buttonconfirme" type="submit" value="'.($nbrquantite).'"> Confirmer</button></td>';
  }
  ...
  if($etat2[$i] == 'refus'){
      echo'<td><button    name ="buttonrefuse" type="submit" value="'.($nbrquantite).'">  Refuser</button></td>';
  }
  else{
      echo'<td><button    name ="buttonrefuse" type="submit" value="'.($nbrquantite).'">  Refuser</button></td>';
  }
  ...
  echo'
<td><button    name ="pdf" type="submit" >PDF</button></td>  
...
<table>
<br>
<h2>Eléments hors forfait : Visiteur(s)</h2>
  <thead>
    <tr>
    <br>
  ...
  for($nbrquantite2 =0;count($lebelle) > $nbrquantite2;$nbrquantite2++ ){
    ...
    <tr>
      ...
      <form action="Affiche_fiche_comptable.php" method="post">
      <td>&nbsp&nbsp&nbsp<button  name ="button2" type="submit" value="'.$nbrquantite2.'">Supprimer</button></td>';
      if($etat[$nbrquantite2] == 'valide'){
          echo'<td><button      name ="buttonconfirme2" type="submit" value="'.$nbrquantite2.'"> Confirmer</button></td>';
      }
      else{
          echo'<td><button    name ="buttonconfirme2" type="submit" value="'.$nbrquantite2.'"> Confirmer</button></td>';
      }
      ...
      if($etat[$nbrquantite2] == 'refus'){
          echo'<td><button    name ="buttonrefuse2" type="submit" value="'.$nbrquantite2.'">  Refuser</button></td>';
      }
      else{
          echo'<td><button    name ="buttonrefuse2" type="submit" value="'.$nbrquantite2.'">  Refuser</button></td>';
      }
