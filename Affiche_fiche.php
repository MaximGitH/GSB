...
include 'Connexion_bdd.php';
  ...
  $montant = array();
    ...
    echo '<center><br><h2>Afficher les éléments présent dans le forfait :</h2><center>
    <table>
      <thead>
        <tr>
...
for($nbrquantite =4;count($quantite) >= $nbrquantite;$nbrquantite = $nbrquantite + 4){
  ...
  echo '<tbody>
    <tr>
      ...
      <button   name ="button" type="submit" value="'.$nbrquantite.'">Supprimer</button>
      </form>
    </tr>
    <tr>
';
  ...
  echo'
      <form action="Affiche_fiche.php" method="post">
      <br>
      &nbsp&nbsp<input class="class="select-text" name ="modifetp" placeholder="Modifier forfait étape"></input></td>
      &nbsp&nbsp<input name ="modifkm" placeholder="Modifier forfait km"></input></td>
      &nbsp&nbsp<input name ="modifnui" placeholder="Modifier forfait nuitée"></input></td>
      &nbsp&nbsp<input name ="modifrep" placeholder="Modifier forfait resto"></input></td>
      </td>

      &nbsp&nbsp<button   name ="buttonmodif" type="submit" value="'.$nbrquantite.'">Modifier</button>
      </form>
   ';};echo'
    </tr>
<tr></tr>
...
<?php }else{
    echo "<center><h2>Aïe, erreur de connexion BDD</h2></center>";
}?>